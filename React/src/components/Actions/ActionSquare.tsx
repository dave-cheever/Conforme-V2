...
function ActionSquare({ action, editAction }: { action: IAction; editAction: (action: IAction) => void }) {
  ...
  return (
    <Box
      ...
      w={['full', 'full', '350px']}
    >
      <Flex data-id="030925-16e930" align="center" h="40px" justify="space-between" p="0px 16px 16px 16px" w="full">
        <Skeleton data-id="030925-27aa26" isLoaded={!!action} rounded="full">
          <Flex data-id="030925-769b7b" alignItems="center">
            ...
            <Flex data-id="030925-be84a4" direction="column" minW={0} ml={3}>
              ...
              <Text data-id="030925-657c0b" color="#818197" fontSize="11px" noOfLines={1}>
        ...
        {!action?.metatags?.updatedAt && (
          <Box data-id="030925-44f761" bg="#41B916" color="#FFF" fontSize="11px" px={2} py="1px" rounded="2px">
            New
          </Box>
        )}
      </Flex>
      <Divider data-id="030925-ff484e" color="#CBD5E0" w="full" />
      <Box data-id="030925-06c417" p="16px">
        <Box
          ...
          <Box data-id="030925-629b68">
            <Text data-id="030925-b02a2e" color="#4A5568" fontSize="14px" fontWeight="600">
              Priority
            </Text>
            <Text data-id="030925-ce02e9" color="#282F36" fontSize="14px" fontWeight="400" textTransform="capitalize">
              {action?.priority ?? '-'}
            </Text>
          </Box>
  
            <Box data-id="030925-2119f5">
              <Text data-id="030925-c4f69f" color="#4A5568" fontSize="14px" fontWeight="600">
                Due in
              </Text>
              <Text data-id="030925-3a4c15" color="#282F36" fontSize="14px" fontWeight="400">
        ...
        <Box data-id="030925-27d9eb" mt={4}>
          <Text data-id="030925-94209a" color="#4A5568" fontSize="14px" fontWeight="600">
            Linked To
          </Text>
          <Flex
          ...
          >
            <Text data-id="030925-822e35" color="#282F36" fontSize="14px" fontWeight="400" noOfLines={1}>
        ...
        <Flex data-id="030925-c2ab84" align="center" justify="space-between" mt={4}>
          <Button
            ...
            rightIcon={<ChevronRight data-id="030925-ae48fc" boxSize="14px" />}
          >
            More
          </Button>
          {isOverdue && (
            <HStack data-id="030925-02b0c2" spacing={2}>
              ...
              <Text data-id="030925-b1f379" color="#DC0043" fontSize="12px" fontWeight="bold">
                Overdue
              </Text>
            </HStack>
          )}
