...
const AuditModal = ({ onClose, isOpen }: IAuditModal) => {
  ...
  return (
    <AuditModalContext.Provider value={{ activePage, setActivePage, selectedArea, setSelectedArea }}>
      <Modal variant="auditModal" onClose={onClose} isOpen={isOpen}>
        <ModalOverlay />
        <ModalContent m="15px 15px"
          h="calc(100vh - 30px)"
          maxW="800px"
          ...
          <ModalHeader m="0px 5px 5px 5px">
            <Box>
              <Breadcrumb
                ...
                <BreadcrumbItem>
                  <Text fontSize="lg" fontWeight="700" color="auditModal.title.text" >Audit</Text>
                </BreadcrumbItem>
                <BreadcrumbItem>
                  <Text fontSize="lg" fontWeight="700" color="auditModal.title.text"
                    m="0px 2px" >Office Hazard Assessment</Text>
                </BreadcrumbItem>
              </Breadcrumb>
            </Box>
            <Box display="flex" justifyContent="start" alignItems="center">
              <Box display="flex" justifyContent="start" alignItems="center" height="40px" w="180px" >
              ...
              <Box display="flex" justifyContent="start" alignItems="center" height="40px" w="230px">
                <LocationIcon mr="8px" boxSize={6} />
                <Text fontWeight="400" fontSize="md" color="auditModal.location.text" >The Meriden Hospital</Text>
              </Box>
              <Box display="flex" justifyContent="start" alignItems="center" height="40px" w="180px" >
          ...
          <ModalFooter>
            <Button w="116px" m="5px 0px"
              bg="auditModal.button.bg"
              _hover={{ bg: "auditModal.button.hoverBg" }} >
              <Text color="white" fontSize="md" fontWeight="400" >Start</Text>
            </Button>
          </ModalFooter>
        </ModalContent>
      </Modal>
