...
interface IActionTemplateDeleteConfirmModal {
  isOpen: boolean;
  onClose: () => void;
  onConfirm: () => void;
...
const ActionTemplateDeleteConfirmModal = ({
  isOpen,
  onClose,
  onConfirm,
  actionTemplateName,
}: IActionTemplateDeleteConfirmModal) => {
  return (
    <Modal data-id="000326" isCentered isOpen={isOpen} onClose={onClose}>
      ...
      <ModalContent bg="white" borderRadius="12px" boxShadow="lg" data-id="000328" p={6} textAlign="center">
        ...
        <Box color="#2D3748" data-id="000330" mb={6}>
          Are you sure you want to delete the action template{' '}
...
export default ActionTemplateDeleteConfirmModal;
