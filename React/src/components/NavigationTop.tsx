              ...
              if (item.permission) {
                return (
                  (<Can
                    ...
                    yes={() => <SubSection data-id="3b7ff7eacbb0" key={item.label} onClick={onClose} showIcon subsection={item}/>} />)
                );
              }
              return <SubSection data-id="e2de2224871c" key={item.label} onClick={onClose} showIcon subsection={item} />;
            })
