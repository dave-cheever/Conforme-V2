...
function QuestionEmailForm({
  ...
  return (
    <>
      <Flex data-id="030925-235ebc" alignItems="center" mb="20px">
        <Text data-id="030925-401515" fontSize="smm" fontWeight="bold">
          {questionHeader(questionType)}
        </Text>
      </Flex>
      <TextInput
        data-id="030925-295e65"
        control={control}
      ...
      <Checkbox
        data-id="030925-03ea84"
        control={control}
        label="Answer is required"
        name="required"
        variant="secondaryVariant" />
      <Flex data-id="030925-a5fde4" justifyContent="space-between" mt="15px">
        <Button
          data-id="030925-a96295"
