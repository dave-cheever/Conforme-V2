  ...
  const renderGroup = (group: string) => (
    <Flex data-id="030925-c6438f" direction="column" key={group}  minW="380px" pl={3} pr={2} pt={2} w="380px">
      ...
      <Stack
        ...
        w="full"
      >
        {filteredResults[group]?.map((audit: IAudit) => <AuditSquare audit={audit} data-id="030925-6f7c4b" key={audit._id} />)}
      </Stack>
    </Flex>
  );

  return (
    <Flex bg="#ffffff" data-id="030925-1d57f5" h="full" overflow="auto" pt="3" w="full">
