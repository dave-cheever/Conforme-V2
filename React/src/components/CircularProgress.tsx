...
function CircularProgress({ value }: ICircularProgress) {
  return (
    <Box data-id="030925-171ada">
      <EllipsisIcon boxSize={2} data-id="030925-f1e571" transform="translate(-22px, 60px)" />
      <EllipsisIcon boxSize={2} data-id="030925-2fef3a" transform="translate(55px, -21px)" />
      <EllipsisIcon boxSize={2} data-id="030925-ec6ebf" transform="translate(57px, 135px)" />
      <EllipsisIcon boxSize={2} data-id="030925-08421f" transform="translate(136px, 55px)" />
      <Progress
        bg="white"
        borderRadius="full"
