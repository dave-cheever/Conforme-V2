...
const CircularProgress = ({ value }: ICircularProgress) => (
  <Box>
    <EllipsisIcon boxSize={2} transform="translate(-22px, 60px)" />
    <EllipsisIcon boxSize={2} transform="translate(55px, -21px)" />
    <EllipsisIcon boxSize={2} transform="translate(57px, 135px)" />
    <EllipsisIcon boxSize={2} transform="translate(136px, 55px)" />
    <Progress
      bg="white"
      borderRadius="full"
