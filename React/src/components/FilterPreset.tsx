...
import DeletePresetModal from './FilterPreset/DeletePresetModal';
import FilterPresetList from './FilterPreset/FilterPresetList';
import SavePresetForm from './FilterPreset/SavePresetForm';
...
function FilterPreset({ placement = 'bottom-start', 'data-id': dataId = 'filter-preset' }: FilterPresetProps) {
  ...
  const getCurrentFilterValues = () => {
    ...
    for (const filterKey of usedFilters) {
...
export { GET_FILTER_PRESETS, SAVE_FILTER_PRESET, DELETE_FILTER_PRESET };
