...
const ResponseLeftTabItem = ({label,icon, url}) => {
    ...
    return (
    <Flex mb={3} align="center" cursor="pointer" onClick={redirectPage}>
        ...
        <Flex fontSize="14px" color={active ? "responseLeftTabItem.activeTextColor" :"responseLeftTabItem.textColor"} ml={3}>{label}</Flex>
    </Flex>
    );
}
