...
const AccidentInvestigationPanel = () => (
  <Box borderRadius="lg" boxShadow="0px 4px 10px rgba(0, 0, 0, 0.05)" h="312px" overflow="hidden" w="270px">
    <Flex alignItems="center" bg="investigationPanel.header" h="37px" px="4">
      ...
      <Text color="investigationPanel.headerText" fontSize="14px" fontWeight="400" pl="2">
        Accident Investigation
      </Text>
    </Flex>
    <Box bg="investigationPanel.bg" h="100%" pt="3" w="100%">
      <Flex align="center">
        <Box bg="investigationPanel.ribbon" display={['none', 'block']} h="50px" roundedRight="4px" w="5px">
          &nbsp;
        </Box>
        <Text color="investigationPanel.text" fontSize="24px" fontWeight="700" ml="4">
          102
        </Text>
      </Flex>
      <Box ml="3" p="3" w="100%">
