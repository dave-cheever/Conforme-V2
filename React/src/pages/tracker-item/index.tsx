...
const TrackerItemResponse = () => {
  ...
  return (<>
    ...
    <VStack
      ...
      <Stack
        align="center"
        data-id="5c5be4db9311"
        direction={['column', 'row']}
        spacing={4}
        w="full">
        <Flex
          cursor={neverReviewed ? 'default' : 'pointer'}
          data-id="3e2945759d8b"
        ...
        {!snapshot && (
          <Flex
            ...
            <Flex
              align="center"
              data-id="83803140aa0a"
              flexDir={['column', 'row']}
              justifyContent="space-between"
              w="full">
              <VStack
                align={['center', 'flex-start']}
                data-id="a43275b82b29"
                spacing={0}
                w="full">
                <Text
                  color="responseRenewalDetails.labelColor"
                  data-id="7659892ee14c"
                  fontSize="11px">
                  Perform new review by
                </Text>
                <Text
                  color="responseRenewalDetails.textColor"
                  data-id="cfe0d57bc939"
                  fontSize="14px">
      ...
      <Box
        ...
        w="full">
        {(response?.trackerItem?.allowAttachments || response?.trackerItem?.evidenceItems?.length > 0) && <Attachments data-id="e29303a626fa" />}
