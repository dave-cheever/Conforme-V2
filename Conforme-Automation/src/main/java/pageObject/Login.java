...
public class Login extends base.commonFunctions{
    ...
    public void clickSignInWithMicrosoftButton() {
        ...
        waitForVisibility(signInWithMicrosoftButton, 30, "Sign in with Microsoft button");
        click(signInWithMicrosoftButton, "Sign in with Microsoft button");
    }

    public void enterEmail(String email) {
        Allure.step("Entering email: " + email);
        waitForVisibility(inputEmail, 30, "Email input field");
    ...
    public void clickNextButton() {
        ...
        waitForVisibility(buttonNext, 30, "Next button");
        click(buttonNext, "Next button");
    }

    public void enterPassword(String password) {
        Allure.step("Entering password");
        waitForVisibility(inputPassword, 30, "Password input field");
    ...
    public void submitLogin() throws InterruptedException {
        ...
        waitForVisibility(buttonNext, 30, "Sign in button");
