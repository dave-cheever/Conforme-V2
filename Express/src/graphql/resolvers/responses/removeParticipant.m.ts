  ...
  try {
    ...
    switch (permission) {
      case 'accountable':
        ...
        if (response.accountableId === participantId) update.accountableId = '';
      ...
      case 'responsible':
        ...
        if (response.responsibleId === participantId) update.responsibleId = '';
      ...
      case 'contributor':
        ...
        update.contributorsIds = response.contributorsIds?.filter(
      ...
      case 'follower':
        ...
        update.followersIds = response.followersIds?.filter(
          (_id) => _id !== participantId,
        );
        break;
      default:
