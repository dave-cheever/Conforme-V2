...
locationsSchema.statics.customUpdateOne = async function (selector: object = {}, updates: Partial<ILocation>, userId: string, organizationId: string): Promise<ILocation> {
